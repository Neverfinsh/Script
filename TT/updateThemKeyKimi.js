  ...
  ui.layout(
    <frame>
      <vertical h="auto" marginTop="20">
        <linear marginTop="30">
          <button id="them_to_article_btn" bg="#8acfaa" text="生成Kimi[themKey ]" marginLeft="35" h="38" />
...
function excuteAritcle(taskResult) {
    ...
    let content = getContentWithKimi(them);
...
function getContentWithKimi(title) {
  ...
  let input_edit_send_btn = className("android.widget.ImageView").depth(9).indexInParent(3).findOne()
