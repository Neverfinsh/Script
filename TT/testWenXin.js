...
getContentWithWenXin("要不咱就爽快一点，来个闪婚吧！咱们先结婚后恋爱，省的再这样耗下去了。你觉得怎么样？彩礼什么的真的不用多，一万八就够了，我还会回礼六万八呢！月薪三千八的你，就能把我领回家，是不是很划算？把这句话润色一下，一定要写一篇150字的文章，要求开头吸引人眼球，要求以第一人称的口吻，语言通俗易懂,情感要真实,段落清晰,使文章更加口语化。")
...
function getContentWithWenXin(title) {
  ...
  let  test=className("android.widget.TextView").depth(32).childCount(0).indexInParent(0).findOne(1000)
